...
namespace MonoScorpPlugin
{
    ...
    internal static class Primitives2D
    {
        ...
        /// </summary>
        /// <param name="spriteBatch">Helper class for drawing text strings and sprites in one or more optimized batches.</param>
        /// <param name="x">The X coordinate of where to put the pixel.</param>
        /// <param name="y">The Y coordinate of where to put the pixel.</param>
        ...
        /// </summary>
        /// <param name="spriteBatch">Helper class for drawing text strings and sprites in one or more optimized batches.</param>
        /// <param name="position">The X and Y coordinate position of the pixel.</param>
        /// <param name="color">The color of the pixel.</param>
        ...
        /// </summary>
        /// <param name="spriteBatch">Helper class for drawing text strings and sprites in one or more optimized batches.</param>
        /// <param name="center">The the coordinate of the center of the circle.</param>
        /// <param name="radius">The radius of the circle.</param>
        /// <param name="sides">The number of sides to generate.</param>
        /// <param name="color">The color of the circle.</param>
        public static void FillCircle(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, Color color)
        {
            ...
            {
                DrawPoints(spriteBatch, center, CreateCircle(i, sides), color, 1.0f);
            }
        }
        ...
        public static void FillCircle(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, Color color, float thickness)
        {
            for (var i = 0; i < radius; i++)
            {
                DrawPoints(spriteBatch, center, CreateCircle(i, sides), color, thickness);
            }
        }
        ...
        /// <param name="sides">The number of sides to generate.</param>
        /// <param name="color">The color of the circle.</param>
        public static void FillCircle(this SpriteBatch spriteBatch, float x, float y, float radius, int sides, Color color)
        {
            for (var i = 0; i < radius; i++)
            {
                DrawPoints(spriteBatch, new Vector2(x, y), CreateCircle(i, sides), color, 1.0f);
            }
        }
        ...
        /// <param name="color">The color of the circle.</param>
        /// <param name="thickness">The thickness of the lines used.</param>
        public static void FillCircle(this SpriteBatch spriteBatch, float x, float y, float radius, int sides, Color color, float thickness)
        {
            for (var i = 0; i < radius; i++)
            {
                DrawPoints(spriteBatch, new Vector2(x, y), CreateCircle(i, sides), color, thickness);
            }
        }
        #endregion
        ...
        /// <summary>
        /// Creates a cached <see cref="Texture2D"/> object that is only 1 x 1 in size to represent a 
        /// single pixel that can be drawn.
        /// </summary>
        /// <param name="spriteBatch">Helper class for drawing text strings and sprites in one or more optimized batches.</param>
